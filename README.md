...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-pj5ryc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-pj5ryc.containers.anotherwebservice.com/
...
```
git clone git@github.com:nipakke/container-pj5ryc.git
cd container-pj5ryc
```
...
```
docker attach container-pj5ryc
```
